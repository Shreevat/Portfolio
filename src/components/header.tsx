...
function Header() {
  ...
  return (
    ...
    >
      ...
      <div onClick={handleLabelClick} className="ml-4 text-center md:text-left relative group">
      ...
      {isMenuOpen && (
        <>
          {/* Backdrop */}
          <div className="fixed inset-0 bg-background/80 backdrop-blur-sm md:hidden z-40" onClick={toggleMenu}></div>
          ...
          >
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-xl font-bold font-roboto-slab text-primary">Menu</h2>
              <button
